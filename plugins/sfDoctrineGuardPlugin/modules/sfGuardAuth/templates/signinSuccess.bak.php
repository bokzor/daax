...
<body>
	...
	<div id="container">
		...
		<hgroup id="login-title" class="large-margin-bottom">
			<h1>Café Basse Cour</h1>
			<h5>&copy; Adrien Bokor</h5>
		</hgroup>

		<form method="post" action="" id="form-login">
			<ul class="inputs black-input large">
				<!-- The autocomplete="off" attributes is the only way to prevent webkit browsers from filling the inputs with yellow -->
				<li><span class="icon-user mid-margin-right"></span><input type="text" name="login" id="login" value="" class="virtual-pad input-unstyled" placeholder="Login" autocomplete="off"></li>
				<li><span class="icon-lock mid-margin-right"></span><input type="password" name="pass" id="pass" value="" class="virtual-pad input-unstyled" placeholder="Password" autocomplete="off"></li>
			</ul>
