...
<html class="linen no-js" lang="en">
	<!--<![endif]-->
	...
	<head>
		...
		<link rel="stylesheet" href="/css/floor.css?v=1">
	...
	<body class="clearfix with-menu with-shortcuts">
		...
		<ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right">
			<?php if($sf_user->isAuthenticated() && $sf_user->hasCredential('manager')): ?>
			<li >
				<a href="#<?php echo url_for('@full_live_commande') ?>" onclick="chargerPage('live');" class="shortcut-live" title="Commandes Live">Commandes Live</a>
			</li>
			<?php endif; ?>
			<?php if($sf_user->isAuthenticated()): ?>
			<li>
				<a href="#<?php echo url_for('@homepage') ?>" onclick="chargerPage('commande');" class="shortcut-notes" title="Passer une commande">Passer une commande</a>
			</li>
			<li>
				<a href="#<?php echo url_for('@gestion_commande') ?>" onclick="chargerPage('gestion/commande');" class="shortcut-commande" title="Gestion commande">Gestion des commandes</a>
			</li>
			<?php endif; ?>
			<?php if($sf_user->isAuthenticated() && $sf_user->hasCredential('manager')): ?>
			<li >
				<a href="#<?php echo url_for('@gestion_utilisateur') ?>" onclick="chargerPage('gestion/utilisateur');" class="shortcut-contacts" title="Gestion utilisateur">Gestion des utilisateurs</a>
			</li>
			<li>
				<a href="#<?php echo url_for('@gestion_stock') ?>" onclick="chargerPage('gestion/stock');" class="shortcut-stock" title="Gestion stock">Gestion du stock</a>
			</li>
			<li>
				<a href="#<?php echo url_for('@gestion_article') ?>" onclick="chargerPage('gestion/article');" class="shortcut-article" title="Gestion des articles">Gestion des articles</a>
			</li>				

			<li>
				<a href="#<?php echo url_for('@stat') ?>" onclick="chargerPage('stat');" class="shortcut-stats" title="Statistiques">Statistiques</a>
			</li>
			<li>
				<a href="#<?php echo url_for('@gestion_tools') ?>" onclick="chargerPage('gestion/outils');" class="shortcut-tools" title="Outils">Outils</a>
			</li>
			<?php endif; ?>
	...
	<!-- Template functions -->
	<script src="/js/floor/configuration.js"></script>
	<script src="/js/jquery-ui-timepicker-addon.js"></script>
	<script src="/js/libs/xdate.js"></script>
    ...
    <script type="text/javascript">
        var images = {
            'image1':     '/image/textures/fabric.png',
            'image2':     '/css/Entypo/entypo-webfont.woff',
        };
