	...
	<table class="table responsive-table" id="sorting-advanced">
		...
		<thead>
			<tr>
				...
				<th scope="col" width="10%" class="align-center ">Temps préparation</th>
				<th scope="col" width="15%" class="align-center hide-on-mobile">Catégorie</th>
				<th scope="col" width="70" class="align-center hide-on-mobile">Editer</th>
		...
		<tbody>
			...
			<tr id="article-<?php echo $article->getId() ?>">
				...
				<td><?php echo $article->getTempsPrepa() ?></td>
				<td><small class="tag"><?php echo $article->getCategory() ?></small></td>
				<td class="low-padding align-center"><a href="#" onclick="editRow('article', <?php echo $article->getId() ?>)" class="button compact icon-gear">Edit</a></td>
				<td class="low-padding align-center"><a href="#" onclick="deleteRow('article', <?php echo $article->getId() ?>, 'delete')" class="button compact icon-gear">Delete</a></td>
			</tr>
			<?php endforeach; ?>
		</tbody>
