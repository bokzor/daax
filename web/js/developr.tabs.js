...
;(function($, window, document)
{
	...
	$.fn.refreshTabs = function()
	{
		...
		this.each(function(i)
		{
			...
			if (back.length === 0)
			{
				back = $('<span class="tabs-back with-left-arrow top-bevel-on-light dark-text-bevel"></span>').prependTo(tabsContent).click(function(event)
				{
