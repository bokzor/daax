...
class sfWidgetFormInputFileEditable extends sfWidgetFormInputFile
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('template', '%file% %input%<br />%delete% %delete_label%');
  }
  ...
  protected function getFileAsTag($attributes)
  {
    ...
    {
      return false !== $this->getOption('file_src') ? $this->renderTag('img', array_merge(array('class' => 'framed small-margin-top small-margin-bottom', 'src' => $this->getOption('file_src')), $attributes)) : '';
    }
    else
    {
